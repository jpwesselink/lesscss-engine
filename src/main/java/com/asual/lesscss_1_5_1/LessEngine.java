...
import com.asual.lesscss_1_5_1.loader.ChainedResourceLoader;
import com.asual.lesscss_1_5_1.loader.ClasspathResourceLoader;
import com.asual.lesscss_1_5_1.loader.CssProcessingResourceLoader;
import com.asual.lesscss_1_5_1.loader.FilesystemResourceLoader;
import com.asual.lesscss_1_5_1.loader.HTTPResourceLoader;
import com.asual.lesscss_1_5_1.loader.JNDIResourceLoader;
import com.asual.lesscss_1_5_1.loader.ResourceLoader;
import com.asual.lesscss_1_5_1.loader.UnixNewlinesResourceLoader;
...
public class LessEngine {
	...
	public LessEngine(LessOptions options, ResourceLoader loader) {
		...
		try {
			...
			URL env = classLoader.getResource("META-INF/1.5.1/env.js");
			URL engine = classLoader.getResource("META-INF/1.5.1/engine.js");
			URL cssmin = classLoader.getResource("META-INF/1.5.1/cssmin.js");
